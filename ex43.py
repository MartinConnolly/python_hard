...
class Scene(object):
	...
	def enter(self):
		print "This scene is not yet configured. Subclass it and emplement enter()."
		exit(1)
...
class CentralCorridor(Scene):
	...
	def enter(self):
		...
		if action == "shoot!":
			...
			print "you are deat. Then he eats you."
			return 'death'
			...
			print "putting im down, then jump through the Weapon Armory door."
			return 'laser_weapon_armory'

		else:
			print "DOES NOT COMPUTE!"
			return 'central_corrdior'
...
class Map(object):
	...
	scenes = {
		'central_corrdior': CentralCorridor(),
